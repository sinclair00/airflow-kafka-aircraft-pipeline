...
<p align="center">
  <img src="docs/images/architecture/aircraft_pipeline_architecture_page1.svg" width="700">
</p>
...
### Airflow 3 Pipeline Execution

The Airflow 3.3.0 DAG orchestrates the complete six-task workflow from Kafka event production through validation, medallion-layer transformations, and summary-report generation. The successful run below completed all six tasks.

![Successful Airflow 3 aircraft maintenance pipeline run](docs/images/airflow/airflow_3_pipeline_success.png)
...
![S3 Medallion Storage](docs/images/s3/s3_medallion_storage.png)

### Snowflake Analytics Layer

Gold-layer summary data is loaded into Snowflake for warehouse-based analytics queries.

![Snowflake Analytics Query](docs/images/snowflake/snowflake_analytics_query.png)
...
![Snowflake Gold Layer](docs/images/snowflake/snowsight_catalog.png)
...
![dbt Lineage](docs/images/dbt/dbt_lineage.png)

### dbt Model Documentation

![dbt Model Documentation](docs/images/dbt/dbt_model_details.png)

### dbt Testing

Automated data quality validation is performed using dbt tests.

![dbt Tests](docs/images/dbt/dbt_tests.png)
...
![Aircraft Maintenance Executive Dashboard](docs/images/powerbi/powerbi_aircraft_maintenance_dashboard.png)
...
Operational and migration procedures are documented in:

- [Airflow 3 Migration Runbook](docs/runbooks/airflow_3_migration_runbook.md)
- [Airflow Pipeline Runbook](docs/runbooks/airflow_pipeline_run.md)
- [Kafka JMX Exporter Runbook](docs/runbooks/kafka_jmx_exporter.md)
- [Prometheus Kafka Validation Runbook](docs/runbooks/prometheus_kafka_validation_runbook.md)
- [Safe Shutdown and Restart Runbook](docs/runbooks/safe_shutdown_restart.md)
- [Docker and WSL Recovery Runbook](docs/runbooks/docker_wsl_recovery.md)
- [Kafka KRaft Migration Runbook](docs/runbooks/kafka_kraft_migration_runbook.md)
